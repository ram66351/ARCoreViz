...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class SelectionManipulator : Manipulator
    {
        ...
        public TranslationManipulator transManipulator;
        public RotationManipulator rotManipulator;
        public GameObject moveGizmoz;
        public GameObject rotGizmoz;
        public Image transImage;
        public Image rotImage;
        public Canvas canvas;

        public static bool RotationMode = false;
        ...
        {
            rotManipulator.enabled = enable;
            rotGizmoz.SetActive(enable);
            RotationMode = true;
            if (enable)
                rotImage.color = new Color(0, 255, 0, 255);
            else
                rotImage.color = new Color(255, 255, 255, 255);
        }

        public void EnableTranslate(bool enable)
        {
            RotationMode = false;
            transManipulator.enabled = enable;
            moveGizmoz.SetActive(enable);
            if(enable)
                transImage.color = new Color(0, 255, 0, 255);
            else
                transImage.color = new Color(255, 255, 255, 255);
        }
